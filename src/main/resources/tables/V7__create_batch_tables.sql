...
SELECT 0, '0'
WHERE NOT EXISTS (SELECT 1 FROM batch.BATCH_STEP_EXECUTION_SEQ);

CREATE TABLE batch.BATCH_JOB_EXECUTION_SEQ (
    ID BIGINT NOT NULL,
    UNIQUE_KEY CHAR(1) NOT NULL,
    CONSTRAINT UNIQUE_KEY_UN_EXEC UNIQUE (UNIQUE_KEY)
);

INSERT INTO batch.BATCH_JOB_EXECUTION_SEQ (ID, UNIQUE_KEY)
SELECT 0, '0'
WHERE NOT EXISTS (SELECT 1 FROM batch.BATCH_JOB_EXECUTION_SEQ);
...
SELECT 0, '0'
WHERE NOT EXISTS (SELECT 1 FROM batch.BATCH_JOB_SEQ);